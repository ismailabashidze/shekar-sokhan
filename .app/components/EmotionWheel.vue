...
const pesLabels = {
  variants: {
    ...
    distraction: 'حواس‌پرتی', surprise: 'تعجب', amazement: 'اعجاب',
    pensiveness: 'تأمل', sadness: 'غم', grief: 'اندوه',
    boredom: 'کسالت', disgust: 'انزجار', loathing: 'تنفر',
