...
const VALIDATION_TEXT = {
  ...
  SPECIALTY_REQUIRED: 'تخصص درمانگر نمی‌تواند خالی باشد',
                ...
                <div class="ltablet:col-span-6 col-span-12 lg:col-span-6">
                  ...
                  >
                    <BaseInput
                      ...
                      :disabled="!isAdmin"
                      label="تخصص"
                      placeholder="تخصص درمانگر را وارد کنید"
                      @update:model-value="handleChange"
                      @blur="handleBlur"
                    />
                  </Field>
                ...
                <div class="col-span-12">
                  ...
                  >
                    <BaseTextarea
                      ...
                      :error="errorMessage"
                      label="توضیح کوتاه"
                      placeholder="یک توضیح کوتاه در مورد درمانگر وارد کنید"
                      @update:model-value="handleChange"
                      @blur="handleBlur"
                    />
                  </Field>
                ...
                <div class="col-span-12">
                  ...
                  >
                    <BaseTextarea
                      ...
                      :error="errorMessage"
                      label="توضیح بلند"
                      placeholder="یک توضیح کامل در مورد درمانگر وارد کنید"
                      rows="4"
                      @update:model-value="handleChange"
                      @blur="handleBlur"
                    />
                ...
                <div class="col-span-12">
                  ...
                  >
                    <BaseTextarea
                      ...
                      placeholder="ویژگی‌های تعریف‌کننده درمانگر را وارد کنید"
                      rows="4"
                      @update:model-value="handleChange"
                      @blur="handleBlur"
                    />
                ...
                <div class="col-span-12">
                  ...
                  >
                    <BaseTextarea
                      ...
                      :error="errorMessage"
                      label="پیشینه"
                      placeholder="پیشینه درمانگر را وارد کنید"
                      rows="4"
                      @update:model-value="handleChange"
                      @blur="handleBlur"
                    />
          ...
          <div class="mx-auto w-full max-w-[410px] sm:pt-28">
              ...
              <div class="col-span-12">
                ...
                >
                  <BaseTextarea
                    ...
                    :error="errorMessage"
                    label="شخصیت"
                    placeholder="شخصیت درمانگر را وارد کنید"
                    rows="4"
                    @update:model-value="handleChange"
                    @blur="handleBlur"
                  />
              ...
              <div class="col-span-12">
                ...
                >
                  <BaseTextarea
                    ...
                    :error="errorMessage"
                    label="ظاهر"
                    placeholder="ظاهر درمانگر را وارد کنید"
                    rows="4"
                    @update:model-value="handleChange"
                    @blur="handleBlur"
                  />
              ...
              <div class="col-span-12">
                ...
                >
                  <BaseTextarea
                    ...
                    :error="errorMessage"
                    label="رویکرد"
                    placeholder="رویکرد درمانگر را وارد کنید"
                    rows="4"
                    @update:model-value="handleChange"
                    @blur="handleBlur"
                  />
            ...
            <div class="mt-6 flex justify-between gap-2">
              <div class="flex items-center justify-between">
                <BaseSwitchThin
                  :model-value="values?.therapist?.isActive ?? false"
                  :disabled="!isAdmin"
                  label="وضعیت درمانگر"
                  help="درمانگر فعال است یا غیر فعال"
                  :sublabel="values.therapist.isActive ? 'درمانگر فعال است' : 'درمانگر غیرفعال است'"
    ...
    <div class="p-4 md:p-6">
      <div class="mx-auto w-full max-w-xs text-center">
        ...
        <p class="font-alt text-muted-500 dark:text-muted-400 text-sm leading-5">
          آیا مطمئن هستید که می‌خواهید این درمانگر را حذف کنید؟ این عمل قابل بازگشت نیست.
        </p>
      </div>
    </div>
