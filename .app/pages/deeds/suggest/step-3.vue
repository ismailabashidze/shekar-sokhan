  ...
  <div>
    ...
    <div class="mx-auto flex w-full max-w-3xl flex-col gap-6 px-4">
      ...
      <div class="flex flex-col gap-2">
        ...
        <BaseInput v-model="deed.title" placeholder="عنوان کار نیک را وارد کنید" rounded="lg" />
      </div>
      ...
      <div class="flex justify-end gap-2">
        <BaseButton to="/deeds/suggest/step-2" variant="outline" rounded="lg">
          بازگشت
        </BaseButton>
        <BaseButton color="primary" rounded="lg" @click="onSubmit">
          ثبت کار نیک
        </BaseButton>
      </div>
    </div>
