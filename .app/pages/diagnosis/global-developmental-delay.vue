<template>
  <div class="from-primary-50 via-white to-blue-50 dark:from-muted-900 dark:via-muted-800 dark:to-muted-900 min-h-screen bg-gradient-to-br">
        ...
        <div class="text-center mb-12">
          <div class="inline-flex items-center gap-3 bg-white/80 dark:bg-muted-800/80 backdrop-blur-sm px-6 py-4 rounded-full shadow-lg border border-white/20 dark:border-muted-700/50 mb-6">
            ...
            <div class="text-right">
              <div class="text-sm text-muted-600 dark:text-muted-400">DSM-5 Code: 315.8 (F88)</div>
              <div class="font-bold text-muted-800 dark:text-white text-lg">Global Developmental Delay</div>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-4 gap-4 max-w-5xl mx-auto">
            <div class="bg-white/80 dark:bg-muted-800/80 backdrop-blur-sm rounded-2xl p-4 shadow-xl border border-white/20 dark:border-muted-700/50">
              ...
              <div class="text-2xl font-bold text-blue-600 dark:text-blue-400 mb-1">{{ disorderInfo.Prevalence }}</div>
            ...
            <div class="bg-white/80 dark:bg-muted-800/80 backdrop-blur-sm rounded-2xl p-4 shadow-xl border border-white/20 dark:border-muted-700/50">
              ...
              <div class="text-xl font-bold text-green-600 dark:text-green-400 mb-1">قبل از ۵ سال</div>
            ...
            <div class="bg-white/80 dark:bg-muted-800/80 backdrop-blur-sm rounded-2xl p-4 shadow-xl border border-white/20 dark:border-muted-700/50">
              ...
              <div class="text-xl font-bold text-purple-600 dark:text-purple-400 mb-1">{{ disorderInfo.suicideRisk }}</div>
            ...
            <div class="bg-white/80 dark:bg-muted-800/80 backdrop-blur-sm rounded-2xl p-4 shadow-xl border border-white/20 dark:border-muted-700/50">
              ...
              <div class="text-lg font-bold text-orange-600 dark:text-orange-400 mb-1">قابل بهبود</div>
    ...
    <div class="container mx-auto max-w-7xl px-4 pb-12">
      ...
      <!-- Specifiers -->
      <div v-if="disorderInfo.specifiers.length > 0" class="bg-white/80 dark:bg-muted-800/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/20 dark:border-muted-700/50 mb-12">
        <div class="text-center mb-8">
      ...
      <div class="bg-white/80 dark:bg-muted-800/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/20 dark:border-muted-700/50 mb-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <div class="bg-gradient-to-r from-red-100 to-red-200 dark:from-red-900/30 dark:to-red-800/30 p-4 rounded-xl text-center">
            <div class="text-red-600 dark:text-red-400 text-2xl font-bold">{{ disorderInfo.diagnosticFeatures.core_symptoms.mandatory.length }}</div>
          ...
          <div class="bg-gradient-to-r from-blue-100 to-blue-200 dark:from-blue-900/30 dark:to-blue-800/30 p-4 rounded-xl text-center">
            <div class="text-blue-600 dark:text-blue-400 text-2xl font-bold">{{ disorderInfo.diagnosticFeatures.core_symptoms.associated.length }}</div>
          ...
          <div class="bg-gradient-to-r from-orange-100 to-orange-200 dark:from-orange-900/30 dark:to-orange-800/30 p-4 rounded-xl text-center">
            <div class="text-orange-600 dark:text-orange-400 text-2xl font-bold">{{ disorderInfo.diagnosticFeatures.contextual_factors.length }}</div>
          ...
          <div class="bg-gradient-to-r from-purple-100 to-purple-200 dark:from-purple-900/30 dark:to-purple-800/30 p-4 rounded-xl text-center">
            <div class="text-purple-600 dark:text-purple-400 text-2xl font-bold">{{ disorderInfo.diagnosticFeatures.differential_diagnostics.length }}</div>
        ...
        <div class="space-y-8">
          ...
          <div class="bg-red-50 dark:bg-red-900/20 p-6 rounded-xl border-2 border-red-200 dark:border-red-800">
            ...
            <div class="mb-4 p-4 bg-red-100 dark:bg-red-900/50 rounded-lg">
              ...
              <p class="text-red-700 dark:text-red-400 text-sm">{{ disorderInfo.diagnosticFeatures.core_symptoms.exclusion_criteria }}</p>
            </div>
          ...
          <div class="bg-green-50 dark:bg-green-900/20 p-6 rounded-xl border-2 border-green-200 dark:border-green-800">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="bg-white dark:bg-green-800/30 p-5 rounded-lg shadow-sm border border-green-200 dark:border-green-700">
                ...
                <p class="text-green-700 dark:text-green-300 text-sm leading-relaxed">{{ disorderInfo.diagnosticFeatures.temporal_pattern.duration }}</p>
              </div>
              ...
              <div class="bg-white dark:bg-green-800/30 p-5 rounded-lg shadow-sm border border-green-200 dark:border-green-700">
                ...
                <p class="text-green-700 dark:text-green-300 text-sm leading-relaxed">{{ disorderInfo.diagnosticFeatures.temporal_pattern.frequency }}</p>
              </div>
              ...
              <div class="bg-white dark:bg-green-800/30 p-5 rounded-lg shadow-sm border border-green-200 dark:border-green-700">
                ...
                <p class="text-green-700 dark:text-green-300 text-sm leading-relaxed">{{ disorderInfo.diagnosticFeatures.temporal_pattern.onset }}</p>
              </div>
              ...
              <div class="bg-white dark:bg-green-800/30 p-5 rounded-lg shadow-sm border border-green-200 dark:border-green-700">
                ...
                <p class="text-green-700 dark:text-green-300 text-sm leading-relaxed">{{ disorderInfo.diagnosticFeatures.temporal_pattern.remission }}</p>
              </div>
            </div>
          ...
          <div class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 p-6 rounded-xl border border-blue-200 dark:border-blue-800">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div class="bg-white dark:bg-blue-900/30 p-5 rounded-lg border border-blue-200 dark:border-blue-700">
                ...
                <p class="text-blue-700 dark:text-blue-300 text-sm">{{ disorderInfo.associated_features.demographic_patterns.age_onset }}</p>
              </div>
              ...
              <div class="bg-white dark:bg-blue-900/30 p-5 rounded-lg border border-blue-200 dark:border-blue-700">
                ...
                <p class="text-blue-700 dark:text-blue-300 text-sm">{{ disorderInfo.associated_features.demographic_patterns.gender_distribution }}</p>
              </div>
              ...
              <div class="bg-white dark:bg-blue-900/30 p-5 rounded-lg border border-blue-200 dark:border-blue-700">
                ...
                <p class="text-blue-700 dark:text-blue-300 text-sm">{{ disorderInfo.associated_features.demographic_patterns.cultural_variations }}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 p-6 rounded-xl border border-purple-200 dark:border-purple-800">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div class="bg-white dark:bg-purple-900/30 p-5 rounded-lg border border-purple-200 dark:border-purple-700">
                ...
                <p class="text-purple-700 dark:text-purple-300 text-sm leading-relaxed">{{ disorderInfo.associated_features.developmental_course.typical_progression }}</p>
              </div>
