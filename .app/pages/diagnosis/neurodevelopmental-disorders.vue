        ...
        <div class="text-center mb-12">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div class="bg-white/80 dark:bg-muted-800/80 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-white/20 dark:border-muted-700/50">
              ...
              <div class="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-1">{{ categoryData.stats.count }}</div>
            ...
            <div class="bg-white/80 dark:bg-muted-800/80 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-white/20 dark:border-muted-700/50">
              ...
              <div class="text-3xl font-bold text-cyan-600 dark:text-cyan-400 mb-1">{{ categoryData.stats.onsetPeriod }}</div>
            ...
            <div class="bg-white/80 dark:bg-muted-800/80 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-white/20 dark:border-muted-700/50">
              ...
              <div class="text-3xl font-bold text-indigo-600 dark:text-indigo-400 mb-1">{{ categoryData.stats.prevalence }}</div>
      ...
      <div class="bg-white/80 dark:bg-muted-800/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/20 dark:border-muted-700/50 mb-12">
        <div class="max-w-4xl mx-auto">
          <div class="text-center mb-8">
            ...
            <h2 class="text-3xl font-bold text-muted-800 dark:text-white mb-4">{{ categoryData.overview.title }}</h2>
          </div>
          ...
          <div class="prose prose-lg prose-muted dark:prose-invert max-w-none text-right leading-relaxed">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-6">
              <div>
                <h4 class="text-lg font-semibold text-muted-800 dark:text-white mb-3">ویژگی‌های کلیدی:</h4>
                <ul class="space-y-2">
                  <li v-for="feature in categoryData.keyFeatures" :key="feature" class="flex items-start gap-2">
              ...
              <div>
                <h4 class="text-lg font-semibold text-muted-800 dark:text-white mb-3">حیطه‌های تأثیرگذاری:</h4>
                <ul class="space-y-2">
                  <li v-for="area in categoryData.impactAreas" :key="area.text" class="flex items-start gap-2">
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                      <div class="flex items-center gap-2 mb-2">
                        ...
                        <h5 class="font-semibold text-blue-800 dark:text-blue-300">سن شروع</h5>
                      </div>
                      <p class="text-blue-700 dark:text-blue-300 text-sm">{{ disorder.ageOfOnset }}</p>
                    </div>
                    ...
                    <div class="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg">
                      <div class="flex items-center gap-2 mb-2">
                        ...
                        <h5 class="font-semibold text-green-800 dark:text-green-300">سیر اختلال</h5>
                      </div>
                      <p class="text-green-700 dark:text-green-300 text-sm">{{ disorder.course }}</p>
                    </div>
                  </div>
                  ...
                  <div v-if="disorder.coreSymptoms">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                      <div
                        ...
                        :key="symptom"
                        class="bg-purple-50 dark:bg-purple-900/20 p-3 rounded-lg border-r-4 border-purple-500"
                      >
                        <p class="text-purple-700 dark:text-purple-300 text-sm">{{ symptom }}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div v-if="disorder.associatedFeatures">
                    ...
                    <div class="flex flex-wrap gap-2">
                      <span
                        ...
                        :key="feature"
                        class="bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300 px-3 py-1 rounded-full text-sm"
                      >
                        {{ feature }}
                      </span>
                    </div>
                  ...
                  <div v-if="disorder.treatmentApproaches">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div
                        ...
                        :key="treatment"
                        class="bg-teal-50 dark:bg-teal-900/20 p-4 rounded-lg text-center"
                      >
                        <Icon name="ph:heart-fill" class="size-6 text-teal-600 dark:text-teal-400 mx-auto mb-2" />
                        <p class="text-teal-700 dark:text-teal-300 text-sm font-medium">{{ treatment }}</p>
                      </div>
                    </div>
                  </div>
      ...
      <div class="bg-white/80 dark:bg-muted-800/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/20 dark:border-muted-700/50">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <h4 :class="`font-semibold text-${resource.color}-800 dark:text-${resource.color}-300 mb-2`">{{ resource.title }}</h4>
            <p :class="`text-sm text-${resource.color}-700 dark:text-${resource.color}-300`">{{ resource.description }}</p>
          </div>
        </div>
      </div>
