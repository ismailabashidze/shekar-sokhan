<template>
  <div class="from-purple-50 via-white to-indigo-50 dark:from-muted-900 dark:via-muted-800 dark:to-muted-900 min-h-screen bg-gradient-to-br">
    <!-- Header Section -->
    <div class="relative overflow-hidden">
      <!-- Background Pattern -->
      <div class="absolute inset-0 opacity-10">
        <div class="absolute inset-0" style="background-image: radial-gradient(circle at 20% 20%, theme(colors.purple.400) 0%, transparent 50%), radial-gradient(circle at 80% 80%, theme(colors.indigo.400) 0%, transparent 50%), radial-gradient(circle at 40% 60%, theme(colors.violet.400) 0%, transparent 50%)"></div>
      </div>
      ...
      <div class="container mx-auto max-w-7xl px-4 py-12 relative">
        ...
        <div class="text-center mb-12">
          <div class="inline-flex items-center gap-3 bg-white/80 dark:bg-muted-800/80 backdrop-blur-sm px-6 py-4 rounded-full shadow-lg border border-white/20 dark:border-muted-700/50 mb-6">
            <div class="bg-gradient-to-r from-purple-500 to-purple-600 p-3 rounded-full relative">
              <Icon name="ph:eye-fill" class="size-8 text-white" />
              <div class="absolute inset-0 bg-purple-400/30 rounded-full animate-ping"></div>
            </div>
            <div class="text-right">
              <div class="text-sm text-muted-600 dark:text-muted-400">DSM-5 Category</div>
              <div class="font-bold text-muted-800 dark:text-white text-lg">Schizophrenia Spectrum</div>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div class="bg-white/80 dark:bg-muted-800/80 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-white/20 dark:border-muted-700/50">
              <div class="bg-gradient-to-r from-purple-500 to-purple-600 p-3 rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center">
                <Icon name="ph:list-numbers" class="size-8 text-white" />
              </div>
              <div class="text-3xl font-bold text-purple-600 dark:text-purple-400 mb-1">{{ disorders.length }}</div>
              <div class="text-sm text-muted-600 dark:text-muted-400">اختلال اصلی</div>
            </div>
            ...
            <div class="bg-white/80 dark:bg-muted-800/80 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-white/20 dark:border-muted-700/50">
              ...
              <div class="text-3xl font-bold text-indigo-600 dark:text-indigo-400 mb-1">0.3-0.7%</div>
              <div class="text-sm text-muted-600 dark:text-muted-400">شیوع کلی</div>
            </div>

            <div class="bg-white/80 dark:bg-muted-800/80 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-white/20 dark:border-muted-700/50">
              <div class="bg-gradient-to-r from-violet-500 to-violet-600 p-3 rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center">
                <Icon name="ph:trend-up" class="size-8 text-white" />
              </div>
              <div class="text-3xl font-bold text-violet-600 dark:text-violet-400 mb-1">بلوغ</div>
              <div class="text-sm text-muted-600 dark:text-muted-400">دوران شروع</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container mx-auto max-w-7xl px-4 pb-12">
      ...
      <div class="bg-white/80 dark:bg-muted-800/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/20 dark:border-muted-700/50 mb-12">
        <div class="max-w-4xl mx-auto">
          <div class="text-center mb-8">
            <Icon name="ph:info" class="size-12 text-purple-500 mx-auto mb-4" />
            <h2 class="text-3xl font-bold text-muted-800 dark:text-white mb-4">درباره طیف اسکیزوفرنی</h2>
          </div>
          ...
          <div class="prose prose-lg prose-muted dark:prose-invert max-w-none text-right leading-relaxed">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-6">
              <div>
                <h4 class="text-lg font-semibold text-muted-800 dark:text-white mb-3">علائم مثبت:</h4>
                <ul class="space-y-2">
                  <li class="flex items-start gap-2">
                    <Icon name="ph:check-circle" class="size-5 text-success-500 shrink-0 mt-0.5" />
              ...
              <div>
                <h4 class="text-lg font-semibold text-muted-800 dark:text-white mb-3">علائم منفی:</h4>
                <ul class="space-y-2">
                  <li class="flex items-start gap-2">
                    <Icon name="ph:minus-circle" class="size-5 text-orange-500 shrink-0 mt-0.5" />
      ...
      <div class="mb-12">
        ...
        <div class="space-y-8">
          ...
          >
                ...
                <div class="flex items-center justify-between">
                  <div class="flex items-center gap-4 flex-1">
                    ...
                    <div class="bg-white/20 backdrop-blur-sm px-3 py-1 rounded-lg border border-white/30">
                      <div class="text-white text-xs font-bold font-mono">{{ disorder.code }}</div>
                    </div>
                  ...
                  <div class="flex items-center gap-3 text-right">
                    <div class="bg-white/20 backdrop-blur-sm px-3 py-1 rounded-lg border border-white/30">
                      <div class="text-white text-xs font-medium">شیوع</div>
                      <div class="text-white text-sm font-bold">{{ disorder.prevalence }}</div>
                    </div>
                    
                    <!-- Details Button -->
                    <button 
                      @click.stop="viewDisorderDetails(disorder)"
                      class="group bg-white/20 hover:bg-white/30 backdrop-blur-sm px-4 py-2 rounded-lg border border-white/30 hover:border-white/50 transition-all duration-200 hover:scale-105"
                      title="اطلاعات تشخیصی تفصیلی"
                    >
                      <div class="flex items-center gap-2">
                        <Icon name="ph:info-fill" class="size-4 text-white" />
                        <span class="text-white text-xs font-medium hidden sm:inline">جزئیات</span>
                      </div>
                    </button>
                  </div>
                </div>
            ...
            >
              <div v-if="expandedItems.has(index)" class="bg-gradient-to-b from-muted-25 to-white dark:from-muted-800/50 dark:to-muted-700">
                <div class="p-8 space-y-6">
                  
                  <!-- Description -->
                  <div>
                    <h4 class="text-lg font-semibold text-muted-800 dark:text-white mb-3">توضیحات</h4>
                    <p class="text-muted-600 dark:text-muted-400 leading-relaxed">{{ disorder.description }}</p>
                  </div>
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-lg">
                      <div class="flex items-center gap-2 mb-2">
                        ...
                        <h5 class="font-semibold text-purple-800 dark:text-purple-300">سن شروع</h5>
                      </div>
                      <p class="text-purple-700 dark:text-purple-300 text-sm">{{ disorder.ageOfOnset }}</p>
                    </div>
                    ...
                    <div class="bg-indigo-50 dark:bg-indigo-900/20 p-4 rounded-lg">
                      <div class="flex items-center gap-2 mb-2">
                        ...
                        <h5 class="font-semibold text-indigo-800 dark:text-indigo-300">سیر اختلال</h5>
                      </div>
                      <p class="text-indigo-700 dark:text-indigo-300 text-sm">{{ disorder.course }}</p>
                    </div>
                  </div>

                  <!-- Core Symptoms -->
                  <div v-if="disorder.coreSymptoms">
                    <h4 class="text-lg font-semibold text-muted-800 dark:text-white mb-3">علائم اصلی</h4>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                      <div
                        v-for="symptom in disorder.coreSymptoms"
                        :key="symptom"
                        class="bg-violet-50 dark:bg-violet-900/20 p-3 rounded-lg border-r-4 border-violet-500"
                      >
                        <p class="text-violet-700 dark:text-violet-300 text-sm">{{ symptom }}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div v-if="disorder.associatedFeatures">
                    <h4 class="text-lg font-semibold text-muted-800 dark:text-white mb-3">ویژگی‌های همراه</h4>
                    <div class="flex flex-wrap gap-2">
                      <span
                        v-for="feature in disorder.associatedFeatures"
                        :key="feature"
                        class="bg-pink-100 dark:bg-pink-900/30 text-pink-700 dark:text-pink-300 px-3 py-1 rounded-full text-sm"
                      >
                        {{ feature }}
                      </span>
                    </div>
                  ...
                  <div v-if="disorder.treatmentApproaches">
                    <h4 class="text-lg font-semibold text-muted-800 dark:text-white mb-3">رویکردهای درمانی</h4>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div
                        v-for="treatment in disorder.treatmentApproaches"
                        :key="treatment"
                        class="bg-emerald-50 dark:bg-emerald-900/20 p-4 rounded-lg text-center"
                      >
                        <Icon name="ph:heart-fill" class="size-6 text-emerald-600 dark:text-emerald-400 mx-auto mb-2" />
                        <p class="text-emerald-700 dark:text-emerald-300 text-sm font-medium">{{ treatment }}</p>
                      </div>
                    </div>
                  </div>
      ...
      <div class="bg-white/80 dark:bg-muted-800/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/20 dark:border-muted-700/50">
        <div class="text-center mb-6">
          ...
          <h2 class="text-2xl font-bold text-muted-800 dark:text-white mb-2">منابع مفید</h2>
          <p class="text-muted-600 dark:text-muted-400">اطلاعات بیشتر و منابع تخصصی</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div class="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 p-6 rounded-xl border border-purple-200 dark:border-purple-800">
            <Icon name="ph:book-open" class="size-8 text-purple-600 dark:text-purple-400 mb-3" />
            <h4 class="font-semibold text-purple-800 dark:text-purple-300 mb-2">راهنمای DSM-5</h4>
            <p class="text-sm text-purple-700 dark:text-purple-300">مرجع اصلی تشخیص اختلالات طیف اسکیزوفرنی</p>
          </div>
          ...
          <div class="bg-gradient-to-br from-indigo-50 to-indigo-100 dark:from-indigo-900/20 dark:to-indigo-800/20 p-6 rounded-xl border border-indigo-200 dark:border-indigo-800">
            <Icon name="ph:pill" class="size-8 text-indigo-600 dark:text-indigo-400 mb-3" />
            <h4 class="font-semibold text-indigo-800 dark:text-indigo-300 mb-2">درمان دارویی</h4>
            <p class="text-sm text-indigo-700 dark:text-indigo-300">آنتی‌سایکوتیک‌ها و داروهای ضدروان‌پریشی</p>
          </div>
          ...
          <div class="bg-gradient-to-br from-violet-50 to-violet-100 dark:from-violet-900/20 dark:to-violet-800/20 p-6 rounded-xl border border-violet-200 dark:border-violet-800">
            <Icon name="ph:users" class="size-8 text-violet-600 dark:text-violet-400 mb-3" />
            <h4 class="font-semibold text-violet-800 dark:text-violet-300 mb-2">حمایت خانوادگی</h4>
            <p class="text-sm text-violet-700 dark:text-violet-300">آموزش و حمایت از خانواده‌های بیماران</p>
          </div>
        </div>
      </div>
