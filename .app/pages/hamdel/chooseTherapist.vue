    ...
    try {
      ...
      const mappedTherapists = activeTherapists.map((therapist) => ({
        ...
        src: therapist.avatar
          ? `https://pocket.zehna.ir/api/files/therapists/${therapist.id}/${therapist.avatar}`
    ...
    <TairoContentWrapper class="mb-10">
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-2">
          <BaseButton
            ...
            shape="curved"
            @click="navigateTo('/hamdel/newAITherapist')"
          >
      ...
      <div class="mt-2">
        <BaseParagraph size="xs" class="text-muted-500 dark:text-muted-400">
          عامل‌های هوش مصنوعی ما برای کمک به شما در زمینه‌های مختلف طراحی شده‌اند. هر عامل دارای ویژگی‌ها و تخصص‌های
          منحصر به فرد است که می‌تواند به شما در بهبود تکنیک های روانشناختی، مدیریت استرس، افزایش اعتماد به نفس، بهبود
          مهارت های اجتماعی و بسیاری از موارد دیگر کمک کند.
        </BaseParagraph>
      </div>
      ...
      <!-- Results grid -->
      <div v-else class="mt-8 grid w-full grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <TransitionGroup
              ...
              <div class="therapist-card-content flex p-6">
                ...
                <div class="mt-auto flex items-center gap-2">
                  <BaseButton
                    ...
                    class="w-full"
                    shape="curved"
                    @click="navigateTo(`/hamdel/editAITherapist?userId=${therapist.id}`)"
                  >
                  ...
                  <BaseButton
                    ...
                    class="w-full"
                    shape="curved"
                    @click="navigateTo(`/hamdel/messaging?therapistId=${therapist.id}`)"
                  >
