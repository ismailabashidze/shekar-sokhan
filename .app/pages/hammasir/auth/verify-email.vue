      ...
      <div class="bg-white dark:bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10">
        <div v-if="!isVerified && !verificationError">
          <div class="text-center">
            ...
            <div class="mt-4">
              <h3 class="text-lg font-medium text-gray-900 dark:text-white">ایمیل تأیید ارسال شد</h3>
        ...
        <div v-else-if="isVerified">
          <div class="text-center">
            ...
            <div class="mt-4">
              <h3 class="text-lg font-medium text-gray-900 dark:text-white">ایمیل شما تأیید شد!</h3>
              <div class="mt-2 text-sm text-gray-500 dark:text-gray-400">
        ...
        <div v-else>
          <div class="text-center">
            ...
            <div class="mt-4">
              <h3 class="text-lg font-medium text-gray-900 dark:text-white">تأیید ایمیل ناموفق</h3>
              <div class="mt-2 text-sm text-gray-500 dark:text-gray-400">
