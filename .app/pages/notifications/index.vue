...
<template>
  <div class="notifications-page bg-muted-50 dark:bg-muted-900 min-h-screen">
    <div class="container-wrapper mx-auto w-full max-w-6xl px-3 sm:px-4 py-4 sm:py-8">
      <!-- Header -->
      <div class="relative z-10 mb-6 sm:mb-8">
        <!-- Title Section -->
        <div class="mb-4 sm:mb-6">
          <h1 class="text-muted-900 text-2xl sm:text-3xl font-bold dark:text-white">
            اعلان‌ها
          </h1>
          <p class="text-muted-500 dark:text-muted-400 mt-1 sm:mt-2 text-sm sm:text-base">
        ...
        <div class="mb-4 sm:hidden">
          <ClientOnly>
            <!-- Mobile Status Bar -->
            <div class="flex items-center justify-between rounded-lg bg-white dark:bg-muted-800 p-3 shadow-sm">
              <!-- Connection Status -->
        ...
        <div class="flex items-center justify-between gap-2 sm:hidden">
          ...
          <ClientOnly>
            <BaseButton
              ...
              variant="outline"
              color="primary"
              class="flex-shrink-0 transition-all duration-200 hover:scale-105"
              @click="showPwaSettings = !showPwaSettings"
            >
          ...
          <ClientOnly>
            <BaseButton
              ...
              size="sm"
              variant="solid"
              class="flex-1 from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 bg-gradient-to-r shadow-lg transition-all duration-200 hover:scale-105 hover:shadow-xl"
              @click="markAllAsRead"
            >
      ...
      <div class="relative z-10 mb-4 sm:mb-6">
        <!-- Mobile Filters -->
        <div class="sm:hidden">
          <span class="text-muted-600 dark:text-muted-300 text-sm font-medium mb-3 block">
            فیلتر:
          </span>
          <div class="grid grid-cols-3 gap-2">
            <BaseButton
              ...
              :class="[
                'transition-all duration-200 text-xs py-2.5',
      ...
      <div class="mx-auto max-w-5xl">
          ...
          >
            <BaseCard class="p-3 sm:p-4 md:p-6">
              <div class="flex items-start gap-3 sm:gap-4">
                <div class="bg-muted-200 dark:bg-muted-700 size-10 sm:size-12 rounded-full flex-shrink-0" />
                <div class="flex-1 space-y-2 sm:space-y-3">
                  <div class="bg-muted-200 dark:bg-muted-700 h-3 sm:h-4 w-3/4 rounded" />
                  <div class="bg-muted-200 dark:bg-muted-700 h-2.5 sm:h-3 w-1/2 rounded" />
                  <div class="bg-muted-200 dark:bg-muted-700 h-2.5 sm:h-3 w-1/4 rounded" />
                </div>
        ...
        >
          <div class="bg-muted-100 dark:bg-muted-800 mb-4 flex size-12 sm:size-16 items-center justify-center rounded-full">
            <Icon name="ph:bell-slash" class="text-muted-400 size-6 sm:size-8" />
          </div>
          <h3 class="text-muted-900 mb-2 text-base sm:text-lg font-semibold dark:text-white text-center">
            هیچ اعلانی وجود ندارد
          </h3>
          <p class="text-muted-500 dark:text-muted-400 text-center text-sm sm:text-base max-w-sm">
          ...
          <ClientOnly>
            ...
            >
              <BaseCard
                ...
                :key="notification.id"
              class="dark:bg-muted-800 border-muted-200 dark:border-muted-700 group relative cursor-pointer border bg-white shadow-sm transition-all duration-300 sm:hover:scale-[1.01] hover:shadow-xl"
              :class="[
                    ...
                    <div class="md:hidden">
                      <div class="flex items-start justify-between gap-2">
                        ...
                        <div class="flex shrink-0 items-start gap-1">
                          <BaseButtonIcon
                            ...
                            size="sm"
                            variant="ghost"
                            class="hover:bg-muted-100 dark:hover:bg-muted-700 rounded-lg p-2 min-h-[40px] min-w-[40px]"
                          ...
                          <BaseButtonIcon
                            ...
                            size="sm"
                            variant="ghost"
                            class="hover:bg-success-50 dark:hover:bg-success-900/10 hover:text-success-600 rounded-lg p-2 min-h-[40px] min-w-[40px]"
                      ...
                      <div class="mt-2 flex items-center justify-between text-xs">
                        <div class="flex flex-col gap-1">
                          ...
                          <span
                            v-if="notification.announceTime"
                            class="text-primary-600 dark:text-primary-400 flex items-center gap-1"
                          >
                        ...
                        <div class="flex items-center gap-2">
                          <BaseButton
                            ...
                            size="sm"
                            variant="outline"
                            class="text-xs px-3 py-2 min-h-[36px] rounded-lg border-info-200 dark:border-info-700 text-info-600 dark:text-info-400 hover:bg-info-50 dark:hover:bg-info-900/10"
                          >
                          ...
                          <BaseButton
                            ...
                            size="sm"
                            variant="outline"
                            class="text-xs px-3 py-2 min-h-[36px] rounded-lg border-primary-200 dark:border-primary-700 text-primary-600 dark:text-primary-400 hover:bg-primary-50 dark:hover:bg-primary-900/10"
                          >
