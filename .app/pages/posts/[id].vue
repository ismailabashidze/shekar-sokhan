...
const posts = [
  ...
  },
  {
    ...
    author: {
      ...
      bio: 'دکتر مریم عباسی، روان درمانگر با تخصص در درمان اختلالات اضطرابی و استرس. عضو هیئت علمی دانشگاه و نویسنده چندین مقاله علمی در زمینه مدیریت استرس و سلامت روان.',
    },
    comments: [
      {
        id: 1,
