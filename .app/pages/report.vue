        ...
        <BaseCard class="p-6" shape="curved">
          <div class="mb-2 flex items-center justify-between">
            <BaseHeading
              ...
              class="text-muted-800 dark:text-white"
            >
              <span>مشخصات دموگرافیک</span>
            </BaseHeading>
          </div>
          <div class="flex justify-between">
            <BaseParagraph size="xs" class="text-muted-400 max-w-full">
              <Icon name="ph:user-duotone" class="size-4" />
              <span>اطلاعات شخصی مراجع</span>
            </BaseParagraph>
          </div>
          <div class="mt-6 space-y-4">
            <div class="border-muted-200 dark:border-muted-700 flex items-center gap-2 border-b pb-3">
              <div class="bg-primary-500/10 dark:bg-primary-500/20 rounded-lg p-2">
                <Icon name="ph:user-circle-duotone" class="text-primary-500 size-5" />
              </div>
              <div>
                <span class="text-muted-400 text-xs font-medium">نام</span>
                <p class="text-muted-800 dark:text-muted-100 text-sm">
                  {{ report.finalDemographicProfile.firstName ?? '—' }}
                </p>
              </div>
            </div>
            <div class="border-muted-200 dark:border-muted-700 flex items-center gap-2 border-b pb-3">
              <div class="bg-primary-500/10 dark:bg-primary-500/20 rounded-lg p-2">
                <Icon name="ph:user-list-duotone" class="text-primary-500 size-5" />
              </div>
              <div>
                <span class="text-muted-400 text-xs font-medium">نام خانوادگی</span>
                <p class="text-muted-800 dark:text-muted-100 text-sm">
                  {{ report.finalDemographicProfile.lastName ?? '—' }}
                </p>
              </div>
            </div>
            <div class="border-muted-200 dark:border-muted-700 flex items-center gap-2 border-b pb-3">
              <div class="bg-primary-500/10 dark:bg-primary-500/20 rounded-lg p-2">
                <Icon name="ph:number-circle-three-duotone" class="text-primary-500 size-5" />
              </div>
              <div>
                <span class="text-muted-400 text-xs font-medium">سن</span>
                <p class="text-muted-800 dark:text-muted-100 text-sm">
                  {{ report.finalDemographicProfile.age ?? '—' }}
                </p>
              </div>
            </div>
            <div class="border-muted-200 dark:border-muted-700 flex items-center gap-2 border-b pb-3">
              <div class="bg-primary-500/10 dark:bg-primary-500/20 rounded-lg p-2">
                <Icon name="ph:gender-intersex-duotone" class="text-primary-500 size-5" />
              </div>
              <div>
                <span class="text-muted-400 text-xs font-medium">جنسیت</span>
                <p class="text-muted-800 dark:text-muted-100 text-sm">
                  {{ report.finalDemographicProfile.gender ?? '—' }}
                </p>
              </div>
            </div>
            <div class="border-muted-200 dark:border-muted-700 flex items-center gap-2 border-b pb-3">
              <div class="bg-primary-500/10 dark:bg-primary-500/20 rounded-lg p-2">
                <Icon name="ph:graduation-cap-duotone" class="text-primary-500 size-5" />
              </div>
              <div>
                <span class="text-muted-400 text-xs font-medium">تحصیلات</span>
                <p class="text-muted-800 dark:text-muted-100 text-sm">
                  {{ report.finalDemographicProfile.education ?? '—' }}
                </p>
              </div>
            </div>
            <div class="border-muted-200 dark:border-muted-700 flex items-center gap-2 border-b pb-3">
              ...
              <div>
                <span class="text-muted-400 text-xs font-medium">وضعیت تأهل</span>
                <p class="text-muted-800 dark:text-muted-100 text-sm">
                  {{ report.finalDemographicProfile.maritalStatus ?? '—' }}
                </p>
              </div>
            </div>
            <div class="flex items-center gap-2">
              <div class="bg-primary-500/10 dark:bg-primary-500/20 rounded-lg p-2">
                <Icon name="ph:briefcase-duotone" class="text-primary-500 size-5" />
              </div>
              <div>
                <span class="text-muted-400 text-xs font-medium">شغل</span>
                <p class="text-muted-800 dark:text-muted-100 text-sm">
                  {{ report.finalDemographicProfile.occupation ?? '—' }}
                </p>
              </div>
            </div>
          </div>
