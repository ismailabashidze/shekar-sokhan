...
definePageMeta({
  title: 'ورود روانشناس - TogetherMama',
  layout: 'empty',
})
...
const login = () => {
  ...
  router.push('/togethermama/psychologist/dashboard')
}
</script>
      ...
      <div class="dark:bg-muted-800 relative mx-auto w-full max-w-sm bg-white">
        ...
        <div>
          ...
          <BaseParagraph size="sm" class="text-muted-400 mb-6 mt-3">
            لطفاً اطلاعات حساب حرفه‌ای خود را وارد کنید
          </BaseParagraph>
          ...
          <div>
            <div class="mt-5">
              ...
              >
                ...
                <NuxtLink
                  to="/togethermama/auth/psychologist/register"
