...
export const useGenerateSessionReport = () => {
  ...
  return useMutation({
    ...
    onSuccess: (_, sessionId) => {
      queryClient.invalidateQueries({ queryKey: ['sessionAnalysis', sessionId] });
    },
  });
};
...
export const useAssessmentAnalyses = (params?: { userId?: string; templateId?: string }) => {
...
export const useMatchmakingAnalyses = (params?: { limit?: number; page?: number }) => {
